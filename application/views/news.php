			...
			<div class="row">
				<div class="col-sm-12 text-xs-center wow  flipInY" data-wow-delay="0s">
							<div class="tdtintuchome">
								<span class="fontdancing">Tips For New Dishes
									  </span>
			...
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="mottinchuan mb-3  wow  fadeInUp">
						...
						<a href="<?php echo base_url() ?>tintuc/chitiettin/<?= $value['id'] ?>"><img src="<?= $value['anhtin'] ?>" alt=""></a>
						<a href="<?php echo base_url() ?>tintuc/chitiettin/<?= $value['id'] ?>" class="tieudetin1 fontoswarld"><?= $value['tieude'] ?></a>
						<div class="ngaythang1"><?= date('d/m/Y',$value['ngaytao'] )?>  in <span class="vang"><?= $value['tendanhmuc'] ?></span></div>
						<p class="fontroboto"><?= $value['trichdan'] ?> </p>

						<div class="docthem mb-2">
							<div class="like float-xs-right fontroboto">10 like</div>
							<a href="<?php echo base_url() ?>tintuc/chitiettin/<?= $value['id'] ?>" class="rm fontroboto">Read More</a>
						</div>
					</div>
					<?php endforeach ?>
					...
					<nav class="phantrang mb-3  wow  fadeInUp">
						<ul class="pagination">
							...
							?>
							<!-- ham nay in ra nut previous khi no khac so 1 -->
							<?php 
							if ($tranghientai==1) {
								...
								?>
									<li class="pre">
									<a href="<?php echo base_url() ?>tintuc/page/<?= (int)$tranghientai-1 ?>" aria-label="Previous">
							...
							?>
							<!-- //Ham nay in ra ca con so 1,2,3 cu trang -->
							<?php 
									for ($i = 0; $i < $sotrang; $i++) 
									{
										?>
				...
				<div class="col-sm-3">
					...
					<div class="khoilistlink my-2  wow  fadeInUp">
						...
						<ul class="fontroboto">
							...
							<?php foreach ($mangdm as $value): ?>
								<li><a href="<?= base_url() ?>tintuc/danhmuc/<?php echo $value['id'] ?>"><?= $value['tendanhmuc'] ?></a></li>
							<?php endforeach ?>
