	    ...
	    <nav class="navbar navbar-light  fontroboto">
	    	<div class="container">    	
			      ...
			      <div class="collapse navbar-toggleable-xs" id="mtren">
			        <a class="navbar-brand text-xs-center text-sm-left" href="<?php base_url() ?>"><img src="<?php base_url() ?>images/logo.png" alt=""></a>
			        ...
			        <ul class="nav navbar-nav float-sm-right">
			          ...
			          <li class="nav-item">
			            <a class="nav-link active " href="<?php echo base_url() ?>trangchu/loadaboutview">About</a>
			          </li>
			          <li class="nav-item">
			...
			<div class="row">
				<div class="col-sm-9">
					<div class="mottinchuan mb-3  wow  fadeInUp fontroboto">
						...
						<img src="<?= $value['anhtin'] ?>" alt="">
						<a href="" class="tieudetin1 fontoswarld"><?= $value['tieude'] ?></a>
						<div class="ngaythang1"><?= date('d/m/Y -G:i-A',$value['ngaytao']) ?>  in <span class="vang"> <?= $value['tendanhmuc'] ?></span></div>
						<p  ><?= $value['trichdan'] ?> </p>
